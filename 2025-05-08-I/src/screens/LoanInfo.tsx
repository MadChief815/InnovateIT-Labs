...
interface LoanInfoProps {
  ...
  repayments: Repayment[]; // Repayments are now included in the loan details response
}
...
const LoanInfoScreen = ({
  ...
  const [loanDetails, setLoanDetails] = useState<LoanInfoProps | null>(null);
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              await SecureStore.setItemAsync("loan_deleted", "true"); // Store loan deleted status
            ...
            <>
              ...
              {showMore && (
                <>
                  ...
                  {/* Added load issue data */}
                  <Text style={[Style.columnData, Style.infoText]}>
                    Loan Issue Date: {loanDetails.lending_date}
                  </Text>
                </>
              )}
            </>
