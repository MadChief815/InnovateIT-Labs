...
const App = () => {
  ...
  useEffect(() => {
    if (Platform.OS === "android") {
      StatusBar.setBackgroundColor("#0000FF"); // Blue
      StatusBar.setBarStyle("light-content"); // Light text
    }
  }, []);

  return (
    <SafeAreaProvider>
      <StatusBar backgroundColor="#0000FF" barStyle="dark-content" />
        ...
        <PaperProvider theme={theme}>
          <NavigationContainer independent={true}>
            ...
            >
              ...
              <Stack.Screen name="AccountFrozenPage" component={AccountFrozenPage} options={{ headerShown: false }} />
